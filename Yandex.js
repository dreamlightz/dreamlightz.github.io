(function ymapsInit(e) {
    ...
    t.performance = function(e) {
        ...
        function i(e, n) {
            for (var t in n)
                if (n.hasOwnProperty(t) && n[t].length && (e.push(t + "=" + n[t].shift()),
                e.length >= g))
                    return
        }
        var o, s, a, u, c = {
        ...
        window.performance || Object.create(null)), d = l.now ? l.now.bind(l) : function() {
            return Date.now()
        }
        , f = l.getEntriesByType ? function(e) {
            return l.getEntriesByType("resource").filter(function(n) {
                return n.name === e
            })[0]
        }
        : function() {}
        , p = {}, v = {}, h = {
            ...
            init: function(e) {
                o = e.url,
                s = "/pid=443/cid=73188/dtype=stred" + e.data,
                a = Boolean(e.useSendBeacon && navigator.sendBeacon),
                u = e.enable,
                y.initTimings = y.getResourceTimings(e.initUrl),
                y.saveResourceTimings("initjs", y.initTimings, {
                    size: !1,
                    cached: !1
                })
            },
            ...
            startMeasure: function(e, n) {
                n = "undefined" == typeof n ? d() : n;
                var t = !1;
                return {
                    finish: function(r) {
                        t || (r = "undefined" == typeof r ? d() : r,
                        y.saveMeasure(e, r - n),
                        t = !0)
                    }
                }
            ...
            saveResourceTimings: function(e, n, t) {
                var r = "object" == typeof n ? n : f(n);
                if (r && (t = t || {},
                e = e.replace(/^@?/, "@"),
                this.saveMeasure(e + ".duration", r.duration),
                r.responseStart)) {
                    var i = 0 === r.transferSize ? 1 : 0;
                    this.saveMeasure(e + ".responseDuration", r.responseEnd - r.responseStart),
                    this.saveMeasure(e + ".requestDuration", r.responseStart - r.requestStart),
                    t.cached !== !1 && this.saveMeasure(e + ".cached", i),
                    t.size === !1 || i || (this.saveMeasure(e + ".encodedSize", r.encodedBodySize / 1024),
                    this.saveMeasure(e + ".decodedSize", r.decodedBodySize / 1024))
                }
            }
        }, g = 40, _ = 5e3, E = null;
        return window.addEventListener("beforeunload", function() {
            y.saveMeasure("combine.total", y.statistics.combine.total),
            y.saveMeasure("combine.modules", y.statistics.combine.modules),
            y.saveMeasure("combine.size", y.statistics.combine.size / 1024),
            t()
        }),
        c.exports = y,
        c.exports
    }();
    var i = t.performance.startMeasure("@initjs.eval");
    t.count = function(e) {
        function n() {
            r.push(arguments)
        }
        ...
        return function(e) {
                ...
                if (e.postMessage) {
                    ...
                    if (a) {
                        var c = "__promise" + Math.random() + "_" + new Date
                          , l = function(e) {
                            e.data === c && (e.stopPropagation && e.stopPropagation(),
                            r())
                        };
            ...
            m.prototype = {
                ...
                then: function(e, n, t, r) {
                    var i = new v;
                    return this._addCallbacks(i, e, n, t, r),
                    i.promise()
                },
                "catch": function(e, t) {
                ...
                _addCallbacks: function(e, t, r, i, o) {
                    ...
                    this._status <= h.RESOLVED && this._progressCallbacks.push({
                        defer: e,
                        fn: i,
                        ctx: o
                    })
                        ...
                        i(function() {
                            for (var i, a, u, c = 0; c < t; )
                                ...
                                u = i.fn) {
                                    ...
                                    o ? a.resolve(n) : s ? a.reject(n) : a.notify(n)
                        })
                    }
                }
            };
            ...
            var _ = {
                ...
                fulfill: function(e) {
                    var n = _.defer()
                      , t = n.promise();
                    return n.resolve(e),
                    t.isFulfilled() ? t : t.then(null, function(e) {
                        return e
                    })
                },
                reject: function(e) {
                ...
                allResolved: function(e) {
                    ...
                    return _._forEach(e, s, s, n.notify, n, r),
                    n.promise()
                },
                allPatiently: function(e) {
                    return _.allResolved(e).then(function() {
                        var n, t, r, i, o = c(e), s = o ? l(e) : d(e), a = s.length, u = 0;
                        if (!a)
                            return o ? [] : {};
                        for (; u < a; )
                            r = s[u++],
                            i = e[r],
                            _.isRejected(i) ? (n || (n = o ? [] : {}),
                            o ? n.push(i.valueOf()) : n[r] = i.valueOf()) : n || ((t || (t = o ? [] : {}))[r] = _.valueOf(i));
                        if (n)
                            throw n;
                        return t
                    })
                ...
                anyResolved: function(e) {
                    var n = new v
                      , t = e.length;
                    return t ? (_._forEach(e, n.resolve, n.reject, n.notify, n),
                ...
                _forEach: function(e, n, t, r, i, o) {
                    for (var s = o ? o.length : e.length, a = 0; a < s; )
                        _.when(e[o ? o[a] : a], p(n, a), t, r, i),
                        ++a
                },
            ...
            _.__nextTick__ = i;
            var E = !0;
            "object" == typeof r && "object" == typeof r.exports && (r.exports = _,
            E = !1),
            "object" == typeof modules && s(modules.define) && (modules.define("vow", function(e) {
                e(_)
            }),
            E = !1),
            "function" == typeof t && (t(function(e, n, t) {
                t.exports = _
            }),
            E = !1),
            E && (e.vow = _)
    ...
    t.utils = function(e) {
        ...
        return r.nextTick = i.__nextTick__,
        i.__nextTick__ = void 0,
        r.isArray = Array.isArray ? Array.isArray : function(e) {
        ...
        r.registerImports = function(e, n, t) {
            for (var i = 0; i < n.length; i++)
                if (t[i].__expand)
                    r.registerImports(e, t[i].__expand.depends, t[i].__expand.imports);
                else {
                    var o = r.accessDeep(e, n[i]);
                    o.parent[o.name] = t[i]
                }
            return e
        }
    ...
    function() {
        ...
        function n(e) {
            return r(e) || r(f + o(e)) || r(t.env.browser.cssPrefix + o(e))
        }
        function r(e) {
        ...
        var u, c = {
            ...
            height: "height"
        }, l = {}, d = {}, f = t.env.browser.cssPrefix.toLowerCase();
        t.supports.css = {
            checkProperty: e,
    ...
    function() {
        ...
        function n() {
            ...
            try {
                ...
                t = r.getContext(n = "webgl", i),
                t || (t = r.getContext(n = "experimental-webgl", i),
                t || (n = null))
            } catch (o) {
                n = null
            }
        ...
        function r(e, n) {
            ...
            for (var t = n.getImageData(49, 49, 2, 2), r = [], i = 0; i < 16; i++)
                r.push(t.data[i]);
        ...
        t.supports.graphics = {
            hasSvg: function() {
                return "svg"in o || (o.svg = document.implementation && document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")),
                o.svg
            },
            hasCanvas: function() {
                if (!("canvas"in o)) {
    ...
    function() {
        function e() {
            var e = !0;
            "MacOS" == t.env.browser.osFamily && /^10\.[0-8](\.|$)/.test(t.env.browser.osVersion) && (e = !1,
            n("OldMac"));
            var o = ["requestAnimationFrame", "Worker", "URL", "Blob", "XMLHttpRequest", "Set", "Map", "WebAssembly"];
            o.forEach(function(t) {
                window[t] || (e = !1,
                n(t))
            }),
            "function" != typeof Math.trunc && (e = !1,
            n("MathTrunc"));
            ...
            if (!s || "webgl" !== s.contextName)
                ...
                !1;
            var a = s.context;
            0 == a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS) && (e = !1,
            n("MAX_VERTEX_TEXTURE_IMAGE_UNITS")),
            a.getExtension("OES_vertex_array_object") || (e = !1,
            n("OES_vertex_array_object")),
            a.getExtension("OES_standard_derivatives") || (e = !1,
            n("OES_standard_derivatives"));
            var u = a.getShaderPrecisionFormat(a.FRAGMENT_SHADER, a.HIGH_FLOAT);
            if (u && 0 != u.precision || (e = !1,
            n("highp")),
            !r()) {
                var c = i();
                e = !1,
        ...
        function i() {
            ...
            return i && (e.vendor = r.getParameter(i.UNMASKED_VENDOR_WEBGL).replace(/\W/g, "_"),
            e.renderer = r.getParameter(i.UNMASKED_RENDERER_WEBGL).replace(/\W/g, "_")),
            e
        }
        var o;
        t.supports.vector = {
    ...
    t.logger = function(e) {
        ...
        return r.exports = {
            assert: function(e, r) {
                e || t.env.debug && console.log(n(i, r))
            },
            log: function(e) {
                t.env.debug && console.log(n(i, e))
            },
            notice: function(e) {
                t.env.debug && console.info(n(i, e))
            },
            warning: function(e) {
                t.env.debug && console.warn(n(i, e))
            },
            error: function(e) {
                console.error(n(i, e))
            },
    ...
    function() {
        ...
        e.androidBrokenBuild = "AndroidBrowser" == e.name && "534.30" == e.engineVersion;
        var r = window.devicePixelRatio || screen.deviceXDPI && screen.deviceXDPI / 96 || 1
          , i = "iOS" === e.osFamily || "Safari" === e.name || "WebKit" === e.engine && "Safari" === e.base;
        "MSIE" == e.name || "IEMobile" == e.name || "Android" == e.osFamily && "Gecko" == e.engine || i || r > 1 && r < 2 ? e.graphicsRenderEngine = "svg" : e.graphicsRenderEngine = "canvas",
    ...
    var s = function(e) {
        ...
        function t(e) {
            ...
            this._remoteLoadingAllowed = d.defer(),
        ...
        function c(e) {
            ...
            return "object" == typeof e && !n && p.call(e, "modules") ? {
                modules: f.isArray(e.modules) ? e.modules : [e.modules],
                data: e.data
            } : n ? {
                modules: e
            } : {
        ...
        t.prototype.define = function(e, n, t, i) {
            ...
            if ("object" == typeof e) {
                ...
                2 === arguments.length && (t = n,
                n = null);
            var l = new r(m.DECLARED,e,s,o,n,t,i,a,u);
            this._define(l)
        }
        ,
        ...
        t.prototype._define = function(e) {
            ...
            if (t) {
                if (t.state >= m.DECLARED)
                    return;
                return t.state !== m.FETCHING && n(),
                t.state = m.DECLARED,
                t.declaration = e.declaration,
                t.context = e.context,
                t.storage = e.storage,
                t.key = e.key,
                e.depends && ("function" == typeof e.depends && (e.depends = e.depends.call({
                    name: e.name
        ...
        t.prototype._resolve = function(e, n) {
            if (!e.dynamicDepends) {
                if (e.state === m.DEFINED)
                    return d.resolve(e.exports);
                if (e.state === m.ERROR)
                    return d.reject(e.exports)
            }
            e.state < m.RESOLVING && !e.resolvingPromise && (e.resolvingPromise = this._resolveCore(e, n).always(function(n) {
                return e.resolvingPromise = void 0,
                n
            }));
            var t = i(e, [n]);
            return d.all([e.resolvingPromise, this._require(t, n)]).then(function() {
                return e.state === m.DEFINED ? d.resolve(e.exports) : d.reject(e.exports)
            })
        }
        ,
        t.prototype._resolveCore = function(e, n) {
            return this._fetchModule(e, n).then(function() {
                return e.state = m.RESOLVING,
                this._require(e.depends, n)
            }, this).then(function(n) {
                function t(n, t) {
                    e.state === m.RESOLVING && (e.state = t ? m.ERROR : m.DEFINED,
                    e.exports = t || n),
                    i && i.resolve(),
                ...
                t.dynamicDepends = e.dynamicDepends ? {
                    getValue: function(n, t) {
                        var r = o(e, n, t);
                        return r === v ? d.reject(new Error("ymaps.modules: dynamic dependency `" + n + "` is not declared.")) : s(r) ? this._require([r], t) : d.resolve([r])
                    }
                    .bind(this),
                ...
                try {
                    ...
                    return e.state = m.ERROR,
                    void (e.exports = u)
                }
                return r ? r : e.state !== m.DEFINED && e.state !== m.ERROR ? (console.warn("ymaps.modules: asynchronous provide is deprecated and will be removed. Module `" + e.name + "`."),
                i = d.defer(),
                i.promise()) : void 0
            }, this)
        }
        ...
        t.prototype.require = function(e, n, t, r) {
            var i = "object" == typeof e && !f.isArray(e)
              , o = 1 === arguments.length;
            i && (n = e.successCallback,
            t = e.errorCallback,
            r = e.context,
            o = !n && !t),
            e = c(e);
        ...
        t.prototype._requireSingle = function(e, n) {
            ...
            return t ? this._resolve(t, n) : this._initialized.then(function() {
                var t = this._findDefinition(e);
                return t ? this._resolve(t, n) : d.reject(new Error("ymaps.modules: module `" + a(e) + "` is not defined."))
            }, this)
        }
        ,
        ...
        t.prototype._saveDefinitionToStorage = function(e, n) {
            if (e.key && e.storage) {
                ...
                for (var t = f.isArray(n.key) ? n.key : [n.key], r = 0, i = t.length; r < i; r++)
        ...
        t.prototype._fetchModule = function(e) {
            return e.state >= m.DECLARED ? d.resolve() : this._loadFullBundle()
        }
        ,
        ...
        t.prototype._loadBundle = function(e) {
            return this._config.fetchBundle(e).then(function(e) {
                ...
                throw console.error('ymaps: Failed to bundle "' + e + '".' + (n ? n.stack || n.message || "" : "")),
                n
            })
        }
        ,
    ...
    t.modules = new s({
        ...
        fetchBundle: function(e) {
            ...
            i.src = t.env.bundles.BASE + t.env.bundles[e],
            i.setAttribute("data-ymaps-api-ns", r),
            i.setAttribute("data-ymaps-api-version", "2.1.78"),
            i.async = !0;
            var o = t.vow.defer();
            return i.onerror = o.reject.bind(o),
            t.ns.__provideBundle = o.resolve.bind(o),
            document.head.appendChild(i),
            o.promise().always(function(e) {
                return delete n[r],
                e
            })
        },
        createSandbox: function(e) {
            ...
            return n.importImages = function(e) {
                return {
                    get: function(n) {
                        return a + e[n].src
                    }
    ...
    t.ns.load = function(e, n, r, i) {
        return "function" == typeof e ? n ? t.ns.ready(["package.full"], e, n) : t.ns.ready(["package.full"], e) : ("string" == typeof e && (e = [e]),
    ...
    function() {
        ...
        t.ns.modules = {
            ...
            define: function(e, n, r, i) {
                return t.modules.define.apply(t.modules, arguments),
                t.ns.modules
            },
    ...
    function(e) {
        function n() {
            l && (t.performance.saveMeasure("ymaps.readyDelay", t.performance.now() - t.performance.initTimings.responseEnd),
            l = !1);
            var e = t.performance.startMeasure("ymaps.ready")
              , n = {};
            arguments.length && (1 != arguments.length || "object" != typeof arguments[0] || arguments[0].length ? "function" != typeof arguments[0] ? (n.require = "string" == typeof arguments[0] ? [arguments[0]] : arguments[0],
            n.successCallback = arguments[1],
            n.errorCallback = arguments[2] && "function" == typeof arguments[2] ? arguments[2] : null,
            n.context = arguments[2] && "object" == typeof arguments[2] ? arguments[2] : arguments[3]) : (n.successCallback = arguments[0],
            n.errorCallback = arguments[1] && "function" == typeof arguments[1] ? arguments[1] : null,
            n.context = arguments[1] && "object" == typeof arguments[1] ? arguments[1] : arguments[2]) : n = arguments[0]);
            var r = n.require || []
              , i = o.all([t.modules.require(r), u, c]).spread(function(n) {
                return t.utils.registerImports(t.ns, r, n),
                e.finish(),
                t.ns
            });
            return i.then(n.successCallback && function(e) {
                setTimeout(n.successCallback.bind(n.context), 0, e)
            }
            , n.errorCallback && function(e) {
                setTimeout(n.errorCallback.bind(n.context), 0, e)
            }
            ),
            i
        }
        ...
        var o = t.vow
          ...
          , u = t.modules.require(s).then(function(e) {
            t.utils.registerImports(t.ns, s, e),
            a.finish(),
            r(t.env.preload.onLoad, t.ns)
        }, function(e) {
            return r(t.env.preload.onError, e),
            o.reject(e)
        })
          , c = "complete" === document.readyState || "interactive" === document.readyState ? o.resolve() : new o.Promise(function(e) {
    ...
    t.modules.define("vectorEngine.loadEngine", ["vow", "Hotspot", "Monitor", "collection.Item", "event.Manager", "hotspot.layer.Hint", "hotspot.layer.optionMapper", "interactivityModel.EventController", "interactivityModel.layer", "option.Manager", "poi.BalloonManager", "util.shapeFactory"], function(e, n) {
        function r() {
            var e = n.defer()
              , r = document.createElement("script");
            return r.onload = e.resolve.bind(e),
    ...
    t.env.hasValidApiKey || (t.env.apikey = void 0,
    	"undefined" != typeof t.env.hasValidApiKey && console.warn("(Yandex Maps JS API): Invalid API key")),
    i.finish()
}
)({
    "vectorVersion": "5.15.2",
    "vectorVersionTimestamp": 1616669727675,
    "cacheVersion": null,
    "type": "production",
    "flags": [],
    "server": {
        "url": "https://api-maps.yandex.ru/2.1.78",
        "path": "build/release",
        "params": {
            "apikey": "<your API-key>",
            "mode": "release",
    ...
    "hosts": {
        ...
        "layers": {
            ...
            "mapj": "https://core-renderer-tiles.maps.yandex.net/tiles?l=mapj&%c&%l",
    ...
    "layers": {
        "map": {
            "version": "21.03.25-0-b210309130700",
            "scaled": true,
            "hotspotZoomRange": [8, 23]
        },
        "sat": {
            "version": "3.781.0"
        },
        ...
        "stv": {
            "version": "2021.03.25.00.13-1"
        },
        "sta": {
            "version": "2021.03.25.00.13-1"
        },
        "carparks": {
            "version": "20210325-012244"
        },
        "trf": {
            "version": "1616669760",
            "scaled": true
    ...
    "token": "d37a8b5f73f5a657f70cf503e8a24282",
    "distribution": {},
    "version": "2.1.78",
    "majorVersion": "2.1",
    "cssPrefix": "ymaps-2-1-78-",
    "tag": "2.1.78-7",
    "coordinatesOrder": "latlong",
    "bundles": {
        "panoramas": "/release/panoramas-8d02ed1377a16bfcc73b4950c04e42d8bed31c02.js",
        "full": "/release/full-ffb813a29f30feadb63b5654242d042b7b6a91aa.js",
        "BASE": "https://yastatic.net/s3/front-maps-static/front-jsapi-v2-1/2.1.78-7/build"
    }
}, null)
